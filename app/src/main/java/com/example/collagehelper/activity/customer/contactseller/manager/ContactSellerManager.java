package com.example.collagehelper.activity.customer.contactseller.manager;
...
public class ContactSellerManager extends BaseManager {
    private ContactSellerPresenter presenter;

    public ContactSellerManager(ContactSellerPresenter presenter){
