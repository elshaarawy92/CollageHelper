...
import com.example.collagehelper.activity.seller.contactcustomer.view.ContactCustomerActivity;
import com.example.collagehelper.activity.seller.fragment.presenter.MessagePresenter;
import com.example.collagehelper.activity.seller.fragment.view.IMessageView;
...
public class MessageFragment extends BaseFragment implements IMessageView {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        rvMessageSeller = view.findViewById(R.id.rv_customer);
    ...
    public void getSuccess(List<ChatDO> list) {
        ...
        for (int i = 0; i < list.size(); i++){
            if (!phoneList.contains(list.get(i).getCustomerPhone())){
                phoneList.add(list.get(i).getCustomerPhone());
            }
        }
        getUser(phoneList);
    }
    ...
    public void getSellerSuccess(User user) {
        ...
        adapter.setOnItemClickListener(new MessageAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                intent.putExtra("customerphone",phoneList.get(position));
